...
public static partial class Result
{
        ...
        )
    {
        return r switch {
            ...
            Err<T, TErr> x => new Err<T, TErrRet>(f(x.Get(), arg0)),
            _ => throw new NotImplementedException()
        };
    }
    public static async Task<Result<T, TErrRet>> MapErrAsync<T, TErr, TErrRet, TArg0>(
        ...
        )
    {
        return r switch {
            Ok<T, TErr> x => new Ok<T, TErrRet>(x.Get()),
            Err<T, TErr> x => new Err<T, TErrRet>(await f(x.Get(), arg0).ConfigureAwait(false)),
            _ => throw new NotImplementedException()
        };
    }
        ...
        )
    {
        return r switch {
            Ok<T, TErr> x => new Ok<T, TErrRet>(x.Get()),
            Err<T, TErr> x => new Err<T, TErrRet>(f(x.Get(), arg0, arg1)),
            _ => throw new NotImplementedException()
        };
    }
    public static async Task<Result<T, TErrRet>> MapErrAsync<T, TErr, TErrRet, TArg0, TArg1>(
        ...
        )
    {
        return r switch {
            Ok<T, TErr> x => new Ok<T, TErrRet>(x.Get()),
            Err<T, TErr> x => new Err<T, TErrRet>(await f(x.Get(), arg0, arg1).ConfigureAwait(false)),
            _ => throw new NotImplementedException()
        };
    }
        ...
        )
    {
        return r switch {
            Ok<T, TErr> x => new Ok<T, TErrRet>(x.Get()),
            Err<T, TErr> x => new Err<T, TErrRet>(f(x.Get(), arg0, arg1, arg2)),
            _ => throw new NotImplementedException()
        };
    }
    public static async Task<Result<T, TErrRet>> MapErrAsync<T, TErr, TErrRet, TArg0, TArg1, TArg2>(
        ...
        )
    {
        return r switch {
            Ok<T, TErr> x => new Ok<T, TErrRet>(x.Get()),
            Err<T, TErr> x => new Err<T, TErrRet>(await f(x.Get(), arg0, arg1, arg2).ConfigureAwait(false)),
            _ => throw new NotImplementedException()
        };
    }
        ...
        )
    {
        return r switch {
            Ok<T, TErr> x => new Ok<T, TErrRet>(x.Get()),
            Err<T, TErr> x => new Err<T, TErrRet>(f(x.Get(), arg0, arg1, arg2, arg3)),
            _ => throw new NotImplementedException()
        };
    }
    public static async Task<Result<T, TErrRet>> MapErrAsync<T, TErr, TErrRet, TArg0, TArg1, TArg2, TArg3>(
        ...
        )
    {
        return r switch {
            Ok<T, TErr> x => new Ok<T, TErrRet>(x.Get()),
            Err<T, TErr> x => new Err<T, TErrRet>(await f(x.Get(), arg0, arg1, arg2, arg3).ConfigureAwait(false)),
            _ => throw new NotImplementedException()
        };
    }
        ...
        )
    {
        return r switch {
            Ok<T, TErr> x => new Ok<T, TErrRet>(x.Get()),
            Err<T, TErr> x => new Err<T, TErrRet>(f(x.Get(), arg0, arg1, arg2, arg3, arg4)),
            _ => throw new NotImplementedException()
        };
    }
    public static async Task<Result<T, TErrRet>> MapErrAsync<T, TErr, TErrRet, TArg0, TArg1, TArg2, TArg3, TArg4>(
        ...
        )
    {
        return r switch {
            Ok<T, TErr> x => new Ok<T, TErrRet>(x.Get()),
            Err<T, TErr> x => new Err<T, TErrRet>(await f(x.Get(), arg0, arg1, arg2, arg3, arg4).ConfigureAwait(false)),
            _ => throw new NotImplementedException()
        };
    }
        ...
        )
    {
        return r switch {
            Ok<T, TErr> x => new Ok<T, TErrRet>(x.Get()),
            Err<T, TErr> x => new Err<T, TErrRet>(f(x.Get(), arg0, arg1, arg2, arg3, arg4, arg5)),
            _ => throw new NotImplementedException()
        };
    }
    public static async Task<Result<T, TErrRet>> MapErrAsync<T, TErr, TErrRet, TArg0, TArg1, TArg2, TArg3, TArg4, TArg5>(
        ...
        )
    {
        return r switch {
            Ok<T, TErr> x => new Ok<T, TErrRet>(x.Get()),
            Err<T, TErr> x => new Err<T, TErrRet>(await f(x.Get(), arg0, arg1, arg2, arg3, arg4, arg5).ConfigureAwait(false)),
            _ => throw new NotImplementedException()
        };
    }
        ...
        )
    {
        return r switch {
            Ok<T, TErr> x => new Ok<T, TErrRet>(x.Get()),
            Err<T, TErr> x => new Err<T, TErrRet>(f(x.Get(), arg0, arg1, arg2, arg3, arg4, arg5, arg6)),
            _ => throw new NotImplementedException()
        };
    }
    public static async Task<Result<T, TErrRet>> MapErrAsync<T, TErr, TErrRet, TArg0, TArg1, TArg2, TArg3, TArg4, TArg5, TArg6>(
        ...
        )
    {
        return r switch {
            Ok<T, TErr> x => new Ok<T, TErrRet>(x.Get()),
            Err<T, TErr> x => new Err<T, TErrRet>(await f(x.Get(), arg0, arg1, arg2, arg3, arg4, arg5, arg6).ConfigureAwait(false)),
            _ => throw new NotImplementedException()
        };
    }
        ...
        )
    {
        return r switch {
            Ok<T, TErr> x => new Ok<T, TErrRet>(x.Get()),
            Err<T, TErr> x => new Err<T, TErrRet>(f(x.Get(), arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7)),
            _ => throw new NotImplementedException()
        };
    }
    public static async Task<Result<T, TErrRet>> MapErrAsync<T, TErr, TErrRet, TArg0, TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TArg7>(
        ...
        )
    {
        return r switch {
            Ok<T, TErr> x => new Ok<T, TErrRet>(x.Get()),
            Err<T, TErr> x => new Err<T, TErrRet>(await f(x.Get(), arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7).ConfigureAwait(false)),
            _ => throw new NotImplementedException()
        };
    }
        ...
        )
    {
        return r switch {
            Ok<T, TErr> x => new Ok<T, TErrRet>(x.Get()),
            Err<T, TErr> x => new Err<T, TErrRet>(f(x.Get(), arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8)),
            _ => throw new NotImplementedException()
        };
    }
    public static async Task<Result<T, TErrRet>> MapErrAsync<T, TErr, TErrRet, TArg0, TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TArg7, TArg8>(
        ...
        )
    {
        return r switch {
            Ok<T, TErr> x => new Ok<T, TErrRet>(x.Get()),
            Err<T, TErr> x => new Err<T, TErrRet>(await f(x.Get(), arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8).ConfigureAwait(false)),
            _ => throw new NotImplementedException()
        };
    }
}